...
@section('content')
		<section class="bg-gray-50 dark:bg-gray-800">
				<div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
						<div class="mx-auto mb-8 max-w-screen-md lg:mb-16">
								<h2 class="mb-4 text-center text-4xl font-extrabold text-gray-900 dark:text-white">Mari Bersama Mewujudkan Kampus
										Idaman Lewat
						...
						<div class="space-y-8 md:space-y-0">
								@for ($i = 0; $i < 7; $i++)
										...
										<div
												...
												<h5 class="mb-2 text-center text-xl font-bold tracking-tight text-gray-900 dark:text-white">Seberapa puas anda
														dengan layanan kampus selama ini ? </h5>

												{{-- radio button --}}
												<div class="flex items-baseline justify-center gap-10 py-8">
														@php
																$options = [
														...
														@foreach ($options as $option => $icon)
																...
																<div class="mb-4 flex items-center">
																		<input id="{{ $option . '_' . $i }}" type="radio" value="{{ $option }}"
																				name="response_{{ $i }}" class="input_emot peer">
						...
						<div class="mt-32 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
								<div>
										<div
												class="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
												<svg class="h-5 w-5 text-primary-600 dark:text-primary-300 lg:h-6 lg:w-6" fill="currentColor"
										...
										<p class="text-gray-500 dark:text-gray-400">Plan it, create it, launch it. Collaborate seamlessly with all
								...
								<div>
										...
										<p class="text-gray-500 dark:text-gray-400">Protect your organization, devices and stay compliant with our
								...
								<div>
										...
										<p class="text-gray-500 dark:text-gray-400">Auto-assign tasks, send Slack messages, and much more. Now power
								...
								<div>
										...
										<p class="text-gray-500 dark:text-gray-400">Audit-proof software built for critical financial operations like
												month-end close and quarterly budgeting.</p>
								</div>
								<div>
										<div
												class="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
		...
		<section class="bg-gray-50 dark:bg-gray-800 dark:bg-gray-900">
